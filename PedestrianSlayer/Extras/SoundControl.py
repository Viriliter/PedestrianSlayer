...
class SoundControl(object):
    """This class controls buzzer and play preloaded melodies"""
    ...
    def play(self,melody,tempo,pause,pace=0.800):
        for i in range(0, len(melody)):		# Play song
            ...
            SoundControl.buzz(self,melody[i],noteDuration)	# Change the frequency along the song note
    ...
    def testAll(self):
        SoundControl.setup(self)
        print ("The Final Countdown")
        SoundControl.play(self,self.final_countdown_melody, self.final_countdown_tempo, 0.30, 1.2000)
        time.sleep(2)
        print ("Per Olssons Bonnagard (Old MacDonald Had A Farm) Melody")
        SoundControl.play(self,self.bonnagard_melody, self.bonnagard_tempo, 0.30, 0.800)
        time.sleep(2)
        print ("Manaderna (Symphony No. 9) Melody")
        SoundControl.play(self,self.manaderna_melody, self.manaderna_tempo, 0.30, 0.800)
        time.sleep(2)
        print ("Deck The Halls Melody")
        SoundControl.play(self,self.deck_the_halls_melody, self.deck_the_halls_tempo, 0.30, 0.800)
        time.sleep(2)
        print ("Crazy Frog (Axel F) Theme")
        SoundControl.play(self,self.crazy_frog_melody, self.crazy_frog_tempo, 0.30, 0.900)
        time.sleep(2)
        print ("Twinkle, Twinkle, Little Star Melody")
        SoundControl.play(self,self.twinkle_twinkle_melody, self.twinkle_twinkle_tempo, 0.50, 1.000)
        time.sleep(2)
        print ("Popcorn Melody")
        SoundControl.play(self,self.popcorn_melody, self.popcorn_tempo, 0.50, 1.000)
        time.sleep(2)
        print ("Star Wars Theme")
        SoundControl.play(self,self.star_wars_melody, self.star_wars_tempo, 0.50, 1.000)
        time.sleep(2)
        print ("Super Mario Theme")
        SoundControl.play(self,self.melody, self.tempo, 1.3, 0.800)
        time.sleep(2)
        print ("Super Mario Underworld Theme")
        SoundControl.play(self,self.underworld_melody, self.underworld_tempo, 1.3, 0.800)
        time.sleep(2)
        print ("Adventure Time Theme")
        SoundControl.play(self,self.adventure_time_melody, self.adventure_time_tempo, 1.3, 1.500)
                        
        SoundControl.destroy(self)
